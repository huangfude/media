...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/wxeditor/css/common.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/wxeditor/css/index.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/wxeditor/css/colorpicker.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/wxeditor/css/editor-min.css">
<script src="${pageContext.request.contextPath}/pages/wxeditor/js/jquery-1.10.2.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/pages/wxeditor/js/colorpicker-min.js" type="text/javascript"></script>
</head>
<body>
	...
	<div class="wxeditor">
		<div class="clearfix">
			...
			<div class="right">
				<div id="bdeditor">
					<script charset="utf-8" src="${pageContext.request.contextPath}/pages/wxeditor/ueditor/ueditor.config.js"
						type="text/javascript"></script>
					<script charset="utf-8" src="${pageContext.request.contextPath}/pages/wxeditor/ueditor/ueditor.all.min.js"
						type="text/javascript">
						
					</script>
					<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
					<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
					<script charset="utf-8" src="${pageContext.request.contextPath}/pages/wxeditor/ueditor/lang/zh-cn/zh-cn.js"
						type="text/javascript"></script>
